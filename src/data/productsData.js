...
export const products = [
  { id: 1, nombre: "Torta Cuadrada de Chocolate", descripcion: "Deliciosa torta de chocolate con capas de ganache y un toque de avellanas. Personalizable con mensajes especiales.", precio: 45000, imagen: TC001, categoria: "tortas", enOferta: false, stock: 10, destacado: true },
  ...
  { id: 8, nombre: "Cheesecake Sin Azúcar", descripcion: "Suave y cremoso, este cheesecake es una opción perfecta para disfrutar sin culpa.", precio: 47000, imagen: PSA002, categoria: "sin-azucar", enOferta: false, stock: 8, destacado: true },
  { id: 9, nombre: "Empanada de Manzana", descripcion: "Pastelería tradicional rellena de manzanas especiadas, perfecta para un dulce desayuno o merienda.", precio: 3000, imagen: PT001, categoria: "individuales", enOferta: false, stock: 20, destacado: true },
  { id: 10, nombre: "Tarta de Santiago", descripcion: "Tradicional tarta española hecha con almendras, azúcar y huevos, una delicia para los amantes de los postres clásicos.", precio: 6000, imagen: PT002, categoria: "individuales", enOferta: false, stock: 18, destacado: true },
  { id: 11, nombre: "Brownie Sin Gluten", descripcion: "Rico y denso, perfecto para quienes necesitan evitar el gluten sin sacrificar el sabor.", precio: 4000, imagen: PG001, categoria: "sin-gluten", enOferta: false, stock: 15, destacado: true },
  { id: 12, nombre: "Pan Sin Gluten", descripcion: "Suave y esponjoso, ideal para sándwiches o para acompañar cualquier comida.", precio: 3500, imagen: PG002, categoria: "sin-gluten", enOferta: false, stock: 15, destacado: true },
  { id: 13, nombre: "Torta Vegana de Chocolate", descripcion: "Torta de chocolate húmeda y deliciosa, hecha sin productos de origen animal, perfecta para veganos.", precio: 50000, imagen: PV001, categoria: "vegano", enOferta: false, stock: 10, destacado: true },
  { id: 14, nombre: "Galletas Veganas de Avena", descripcion: "Crujientes y sabrosas, una excelente opción para un snack saludable y vegano.", precio: 4500, imagen: PV002, categoria: "vegano", enOferta: false, stock: 20, destacado: true },
  { id: 15, nombre: "Torta Especial de Cumpleaños", descripcion: "Diseñada especialmente para celebraciones, personalizable con decoraciones y mensajes únicos.", precio: 55000, imagen: TE001, categoria: "especial", enOferta: false, stock: 5, destacado: true },
  { id: 16, nombre: "Torta Especial de Boda", descripcion: "Elegante y deliciosa, diseñada para ser el centro de atención en cualquier boda.", precio: 60000, imagen: TE002, categoria: "especial", enOferta: false, stock: 5, destacado: true },
];
